...
static const char col_highlight[]   = "#d0b03c";
...
static const char *dmenucmd[] = { "dmenu_run", "-i", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray2, "-nf", col_gray3, "-sb", col_highlight, "-sf", col_gray1, NULL };
